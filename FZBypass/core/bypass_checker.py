...
async def direct_link_checker(link, onlylink=False):
    ...
    # DDL Links
        ...
        blink = await transcript(link, "https://golink.gyanitheme.com/", "www.hipsonyc.com/", 8)
    elif bool(match(r"https?:\/\/.+\.tnshort\.\S+", link)):
        blink = await transcript(link, "https://go.tnshort.net/", "https://jrlinks.in/", 2)
        ...
        blink = await transcript(link, "https://go.tnshort.net/", "https://jrlinks.in/", 0.8)
        ...
        blink = await transcript(link, "https://indyshare.net", "https://tamilkey.in/", 3.1)
        ...
        blink = await transcript(link, "https://gadgets.webhostingtips.club/", "https://earnme.club/", 8)
